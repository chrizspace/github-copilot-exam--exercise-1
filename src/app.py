...
activities = {
    ...
    "Basketball Team": {
        "description": "Competitive basketball league and team practice",
    ...
    "Music Ensemble": {
        "description": "Band and orchestra practice for various instruments",
    ...
    "Science Club": {
        "description": "Explore biology, chemistry, physics, and STEM projects",
